...
public interface MIDLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MIDLParser#sign_int}.
	 * @param ctx the parse tree
	 */
	void enterSign_int(MIDLParser.Sign_intContext ctx);
	/**
	 * Exit a parse tree produced by {@link MIDLParser#sign_int}.
	 * @param ctx the parse tree
	 */
	void exitSign_int(MIDLParser.Sign_intContext ctx);
	/**
	 * Enter a parse tree produced by {@link MIDLParser#unsign_int}.
	 * @param ctx the parse tree
	 */
	void enterUnsign_int(MIDLParser.Unsign_intContext ctx);
	/**
	 * Exit a parse tree produced by {@link MIDLParser#unsign_int}.
	 * @param ctx the parse tree
	 */
	void exitUnsign_int(MIDLParser.Unsign_intContext ctx);
	/**
